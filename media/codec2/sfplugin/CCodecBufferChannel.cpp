...
bool CCodecBufferChannel::handleWork(
    ...
    if (work->result == C2_OK){
        ...
        if (work->input.flags & C2FrameData::FLAG_DROP_FRAME) {
            // NOTE: This is to solve backward compatibility issue of queueDummyWork.
            // If no HAL fix, we will receive C2_NOT_FOUND here and then
            // issue fatal error to MediaCodec.
