...
// QTI_BEGIN: 2023-06-23: Display: sfplugin: do not fail resume call if inputs slots are active
        } else if (err == WOULD_BLOCK) {
             ALOGI("Resuming with input buffers not a fatal error");
// QTI_END: 2023-06-23: Display: sfplugin: do not fail resume call if inputs slots are active
        } else {
