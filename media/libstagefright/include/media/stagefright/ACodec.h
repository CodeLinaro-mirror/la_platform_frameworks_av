...
protected:
    virtual ~ACodec();
    virtual status_t setupCustomCodec(status_t err, const char *mime, const sp<AMessage> &msg);
    virtual status_t GetVideoCodingTypeFromMime(const char *mime, OMX_VIDEO_CODINGTYPE *codingType);
